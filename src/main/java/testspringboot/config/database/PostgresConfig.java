...
@Configuration
@EnableJpaRepositories(basePackages = {"testspringboot.repositories"},
        entityManagerFactoryRef = "jpaEntityManagerFactory",
        transactionManagerRef = "jpaTransactionManager")
public class PostgresConfig {

    private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = {"testspringboot.models.entites"};
